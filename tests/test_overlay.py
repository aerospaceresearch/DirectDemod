...
class TestOverlay(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.borders   = 'tests/data/overlay/shapes/borders.shp'
        cls.with_over = 'tests/data/overlay/with_overlay.tif'
        cls.no_over   = 'tests/data/overlay/no_overlay.tif'
        cls.f         = 'tests/data/overlay/_sample.tif'
